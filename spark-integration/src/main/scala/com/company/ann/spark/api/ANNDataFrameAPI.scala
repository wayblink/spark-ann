...
import com.company.ann.spark.builder.{ANNIndexBuilder, FileDiscovery, FileGroup, FileGroupingStrategy}
...
object ANNIndexAPI {
  ...
  def discoverDataFiles(
    ...
    dataPath: String,
    vectorColumn: String
  ): Array[com.company.ann.spark.builder.DataFileInfo] = {
   ...
   */
  def groupFiles(
    files: Array[com.company.ann.spark.builder.DataFileInfo],
    strategy: com.company.ann.spark.builder.GroupingStrategy,
